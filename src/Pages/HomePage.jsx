                ...
                <div className="w-1/2 space-y-6">
                    ...
                    <p className="text-xl text-gray-200">
                        ...
                        <div className="space-6">
                            ...
                            <Link to="/contact">
                            <button className="border border-yellow-500m px-5 py-3 rounded-md font-semibold text-lg cursor-pointer hover:bg-yellow-600 translate-all ease-in-out duration-300">
                                Contact Us
                            </button>
                            </Link>
                        </div>
